...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🧚 Qrupa əlavə edin!", url="https://t.me/Rahid_Crocodile_Bot")
        ...
        update.message.reply_oyunu( 'Salam, Mən Crocodile oyunun aparıcısıyam Mə', reply_to_message_id=True, reply_markup=reply_markup)
    else:
